...
export const getArticleListByPageService = (page: number, pageSize: number) =>
  request.get(buildQuery('/api/article/page', { page: page, pageSize: pageSize }))
...
export const getArticleListByTagService = (id: number) => 
request.get(buildQuery('/api/article/tag', { tagId: id }))
