<template>
  <div class="container">
    <div v-if="articleList.length > 0"  class="article-item" v-for="article of articleList" :key="article.id">
      <div class="item-left">
        <ImageWithFallback class="image" :src="article.articleCover" />
      </div>
      <div class="item-right">
        <div class="title">
          <div class="title-link pointer" 
...
@use '/src/static/styles/transition.scss' as *;
