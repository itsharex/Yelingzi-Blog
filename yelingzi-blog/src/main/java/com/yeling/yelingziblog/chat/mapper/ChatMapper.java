package com.yeling.yelingziblog.chat.mapper;

import com.yeling.yelingziblog.chat.dto.GroupChatMessageDto;
import com.yeling.yelingziblog.chat.dto.MessageListDto;
import com.yeling.yelingziblog.chat.dto.SingleChatMessageDto;
...
public interface ChatMapper {
    ...
    @Insert("""
            INSERT INTO group_chat(user_id, nickname, user_avatar, message, to_group, ip, message_type)
            VALUES (#{userId}, #{nickname}, #{userAvatar}, #{message}, #{toGroup}, #{ip}, #{type})
            """)
    @Options(useGeneratedKeys = true, keyProperty = "id")
